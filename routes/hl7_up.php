...
use App\Http\Controllers\hl7\MIRHL7Controller;
...
Route::get('MIRHL7', [MIRHL7Controller::class, 'HL7']);
//Route::get('MIRcmsMakeHL7File', [MIRHL7Controller::class, 'cmsMakeHL7File']);
Route::get('MIRupdateCMSHL7QueueStatus', [MIRHL7Controller::class, 'updateCMSHL7QueueStatus']);
Route::get('MIRUpdateForPaymentQueue', [MIRHL7Controller::class, 'UpdateForPaymentQueue']);
...
//CENTRAL 
Route::get('cenGetAccessionMapUpdate', [MIRHL7Controller::class, 'cenGetAccessionMapUpdate']);
Route::get('Acc300OnCENStatusAsc', [MIRHL7Controller::class, 'Acc300OnCENStatusAsc']);
Route::get('Acc301OnCENStatusAsc', [MIRHL7Controller::class, 'Acc301OnCENStatusAsc']);
Route::get('Acc400OnCENStatusAsc', [MIRHL7Controller::class, 'Acc400OnCENStatusAsc']);
Route::get('Acc420OnCENStatusAsc', [MIRHL7Controller::class, 'Acc420OnCENStatusAsc']);

...
class SummaryPageTransactionsController extends Controller
{
    /**
...
*/
	...
	$trans = PaymentHistory::getTransactionByQueue($id);
	return view('cms/pages.summary', ['QID' => $id, 'itemData' => json_encode($trans) ] );
    }

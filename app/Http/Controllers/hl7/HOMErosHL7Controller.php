...
class HOMErosHL7Controller extends Controller
{
    /**
				...
				foreach($trans as $trx)
				{
					...
					foreach($insList as $iList)
					{
						...
						elseif($CodeItem != 'HPLUS')
						{
							...
							DB::connection('CMS')->table('AccessionNo')->updateOrInsert(['AccessionNo' => $nCode, 'IdQueue' =>$que->QId, 'IdCompany' =>$trx->IdCompany, 'IdDoctor' =>$trx->IdDoctor, 'ItemCode' =>$iList->CodeItemPrice ]);
						}

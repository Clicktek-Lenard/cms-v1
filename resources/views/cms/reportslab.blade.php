...
<div class="container-fluid">
        ...
        <div class="col-menu-10">
            <div class="header-crumb">
                <ol class="breadcrumb" style=" border-radius:0; " >
                    <li class="active"><a href="{{ '/reports/labreports' }}" class="waiting">Laboratory - Reports <span class="badge" style="top:-9px; position:relative;"></span></a></li>
                </ol>
            </div>
        </div>
    </div>
	<div class="body-content row">
		...
		<form id="formReportCreate" class="form-horizontal" role="form" method="POST" action="{{ '/reports/labreports' }}" autocomplete="off">
						...
						<div class="col-sm-2 col-md-4">
							<div class="input-group">
								<select class="form-control generateType" name="_repType"  placeholder="Select Report Type" required="required">
									...
									<option value="labAPEPEME">Lab APE/PEME Report</option>
								</select>

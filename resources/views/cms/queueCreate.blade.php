...
<div class="container-fluid">
        ...
        <div class="col-menu-10">
            <div class="header-crumb">
                <ol class="breadcrumb" style=" border-radius:0; " >
                    <li><a href="{{ '/cms/queue' }}">Queue <span class="badge" style="top:-9px; position:relative;"></span></a></li>
	...
	<div class="body-content row">
        ...
        <form id="formQueueCreate" class="form-horizontal" role="form" method="POST" action="{{ '/cms/queue' }}" autocomplete="off">
		...
		@endif
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
						<div class="row form-group row-md-flex-center">
							...
							<div class="col-sm-10 col-md-10">
                                <div class="input-group">
									...
									<input type="hidden" name="IdPhysician" />
                                    <div id="PatientName">
                                    <input type="text" class="typeahead form-control" name="PatientName" placeholder="Patient Name" required="required" >
                                   	</div>
                                    <div class="input-group-btn">
                                    	<button class="newbtn btn btn-warning" type="button"> New </button>
                                       	<button class="editbtn btn btn-success disabled" type="button" disabled="disabled" > Edit </button>
                        ...
                        <div class="row form-group row-md-flex-center">
							...
							<div class="col-sm-3 col-md-3">
								<input type="text" class="form-control" name="DOB"  placeholder="Date of Birth" readonly="readonly" required="required">
							</div>
                            <div class="col-sm-1 col-md-1 pad-0-md text-right-md">
                            	<label class="bold">Gender<font style="color:red;">*</font></label>
                            </div>
							<div class="col-sm-3 col-md-3">
								<input type="text" class="form-control" name="Gender" placeholder="Gender" readonly="readonly" required="required">
							</div>
			...
			<div class="row form-group row-md-flex-center">
				<div class="col-sm-2 col-md-2 pad-left-1-md text-left-md">
					<label class="bold">Lane</label>
				</div>
				<div class="col-sm-4 col-md-4 pad-0-md">
					<select name="Priority" class="form-control" placeholder="Priority" data-placeholder="Priority" required="required">
...
$(document).ready(function(e) {
	...
	//dateLastDose.val(formatDate(TodayDate));

...
<div class="row form-group row-md-flex-center">
    ...
    <div class="col-sm-10 col-md-10">
    	<select name="modalDoctors" class="form-control rowview" placeholder="Doctor's Name" disabled="disabled">
...
$(document).ready(function(e) {
   ...
   table.on('draw', function(){
	...
	if( typeof(datas.length) === 'undefined')
		...
		companys = datas;
	$('select[name="modalCompanys"]').selectize({
		sortField: 'Name',
	...
	if( typeof(datas.length) === 'undefined')
		...
		packages = datas; 
	var $package = $('select[name="modalPackage"]').selectize({
		sortField: 'Code',
	...
	var $pack = $package[0].selectize;	
	$pack.setValue(packages[0].Id);

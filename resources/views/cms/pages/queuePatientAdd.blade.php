...
<div class="modal-cms-header">
	<div class="row form-group row-md-flex-center">
		...
		<div class="col-sm-5 col-md-5">
			<input type="text" style="text-transform: capitalize;" class="form-control" name="FullName" value="" placeholder="System Generated - (Last Name, First Name Middle Name)" readonly="readonly" >
		</div>
		<div class="col-sm-2 col-md-2 pad-0-md text-right-md  ">
			<label class="bold ">Code<font style="color:red;">*</font></label>
		</div>
		<div class="col-sm-3 col-md-3">
		<input type="text" class="form-control" name="Code" value="" placeholder="System Generated" readonly="readonly" >
		</div>
	</div>
	<!--LEFT-->
	<div class="row form-group row-md-flex-center">
		...
		<div class="m-top100 col-sm-7 col-md-7">
			<input type="text" style="text-transform: capitalize;" class="form-control" name="LastName" value="" placeholder="Last Name"  required="required">
		</div>
		<!--RIGHT-->
		<div class="float-md-right col-xs-3 col-sm-3 col-md-3 col-lg-3">
			<div class="text-center" >
				<img class="float-right webcam" src="" width="150" height="150" />
	...
	<div class="row form-group row-md-flex-center">
		...
		<div class="m-top170 col-sm-7 col-md-7">
			<input type="text" style="text-transform: capitalize;" class="form-control" name="FirstName" value="" placeholder="First Name"  required="required"> 
		</div>
	</div>
	<div class="row form-group row-md-flex-center">
		...
		<div class="m-top90 col-sm-7 col-md-7">
			<input type="text" style="text-transform: capitalize;" class="form-control" name="MiddleName" value="" placeholder="Middle Name" >
		</div>
	</div>		
	<div class="m-top20 row form-group row-md-flex-center">
		...
		<div class="col-sm-3 col-md-3">
			<input type="text" class="form-control datepicker datepickerPatient datepickerDOB" name="DOB" value="" placeholder="Date of Birth" required="required">
			<span style="color: blue; text-align: center; font-size: small;"><i>mm/dd/yyyy</i></span>
		</div>		
	...
	<div class="row form-group row-md-flex-center">
		...
		<div class="col-sm-3 col-md-3">
			<input type="text" class="form-control" name="SeniorId" value="" placeholder="Senior No" >
		</div>
		<div class="col-sm-1 col-md-1 pad-0-md text-right-md ">
			<label class="bold">PWD</label>
		</div>
		<div class="col-sm-3 col-md-3">
			<input type="text" class="form-control" name="PWD" value="" placeholder="PWD No." id="oscaPwdInput">
		</div>
		<div class="col-sm-1 col-md-1 pad-0-md text-right-md ">
			<label class="bold">PWD Date Expire</label>
		</div>
		<div class="col-sm-2 col-md-2">
			<input type="" class="form-control datepickertwo" name="ExpiryDatePWD" value="" placeholder="Date Expire" id="oscaPwdDateExpire" disabled>
		</div>
	</div>
	<div class="row form-group row-md-flex-center">
		<div class="col-sm-2 col-md-2 pad-0-md text-right-md  ">
		...
		<div class="col-sm-7 col-md-7">
			<input type="text" class="form-control" name="PassPortNo" value="" placeholder="Passport No." >
		</div>
	</div>	
   ...
   <div class="row form-group row-md-flex-center">
        ...
        <div class="col-sm-10 col-md-10">
            ...
            <input type="text" class="form-control" name="Address1" value="" placeholder="No. Street" >
        </div>
    </div>
    ...
    <div class="row form-group row-md-flex-center">
        ...
        <div class="col-sm-2 col-md-2">
            <input type="text" class="form-control" name="Phone1" value="" placeholder="Primary Phone" >
        </div>
        <div class="col-sm-1 col-md-1 pad-0-md text-right-md  ">
            <label class="bold ">Mobile No.</label>
        </div>
        <div class="col-sm-2 col-md-2">
            <input type="text" class="form-control" name="Phone2" value="" placeholder="Phone" >
        </div>
    </div>
</div>
</form>
...
concatStr = function() {
    ...
    var suffixName = $('select[name="SuffixName"]').val() || '';

    var fullName = lastName + ', ' + firstName +  ' ' + suffixName + ' ' + middleName;

    $('input[name="FullName"]').val(fullName);

    var initials = [lastName, firstName, middleName].map(function(name) {
        return name.charAt(0);
    }).join('');

};

$('input[name="LastName"], input[name="FirstName"], input[name="MiddleName"]').on('input', concatStr);
concatAdd = function(){
	var concatstr = '';
...
$(document).ready(function(e) {
	...
	$('.datepickerDOB').datepicker({ maxDate: '+0', firstDay: 1, dateFormat: 'mm/dd/yy', changeMonth: true, changeYear: true, yearRange: 'c-100:c+10'})
	.on('change',function(){

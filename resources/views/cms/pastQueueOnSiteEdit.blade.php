...
<div class="container-fluid">
        ...
        <div class="col-menu-10">
            <div class="header-crumb">
                <ol class="breadcrumb" style=" border-radius:0; " >
                    <li><a href="{{ '/cms/pastqueueonsite' }}">Past Queue (IMD)<span class="badge" style="top:-9px; position:relative;"></span></a></li>
    ...
    <div class="navbar-fixed-bottom" >
        <div class="col-menu">
			...
			<div class="col-md-6">
				<a  class="rtngbtn btn btn-primary col-xs-4 col-sm-4 col-md-4 col-lg-4 pull-right" style="  border-radius:0px; line-height:29px;" type="button"><span class="spinnerbtn"><i class="fa fa-spinner fa-spin hide"></i></span> Routing Slip</a>
			</div>
...
$(document).ready(function(e) {
	...
	$('.rtngbtn').on('click',function(e){  
		if($(this).attr('disabled') !== 'disabled' )
		{
			...
			var hyperlink = document.createElement('a');
			hyperlink.href = "http://{{$_SERVER['SERVER_ADDR']}}:8080/jasperserver/flow.html?_flowId=viewReportFlow&standAlone=true&_flowId=viewReportFlow&ParentFolderUri=%2Freports%2FBilling&reportUnit=%2Freports%2FBilling%2FRS_v3_PastQ_RE&j_username=report&j_password=DnCMSReport&output=pdf&appointmentID="+id+"&myID="+userId;
			var mouseEvent = new MouseEvent('click', {
				view: window,
				bubbles: true,
				cancelable: true

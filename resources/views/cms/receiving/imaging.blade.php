        ...
        <div class="col-menu-10">
            <div class="header-crumb">
                <ol class="breadcrumb" style=" border-radius:0; " >
                    <li class="active"><a href="{{ '/specimen-receiving/imaging' }}" class="waiting">Imaging Receiving <span class="badge" style="top:-9px; position:relative;"></span></a></li>
                </ol>
            </div>
        </div>
    </div>
...
$(document).ready(function(e)
{
    ...
    $searchInput.on('input', function() {
		...
		$('#QueueListTable').on('click','.data-row',function(e){
            ...
            sendout.setData('pageToLoad', '/specimen-receiving/specimen/' + id + '/editImaging?subgroup=XRAY,ECG');
            sendout.setData('queueId', id); // Store queueId in dialog data
            sendout.setData('subgroup', 'XRAY');
        ...
        var sendout = new BootstrapDialog({
            ...
            },
            {
                ...
                action: function (modalRef) {
                    ...
                    $.ajax({
                        url: `/specimen-receiving/specimen/${queueId}/receive?subgroup=XRAY,ECG&type=imaging`,
                        method: 'POST',
                        data: {
...
$(document).ready(function(e)
{
    ...
    var table = $('#QueueListTable2').DataTable({
        ...
        { "data": "ItemCode", "render": function(data,type,row,meta) { return '<div class="wrap-row">'+data+ ' - ' + row.ItemDescription + '</div>'; } },

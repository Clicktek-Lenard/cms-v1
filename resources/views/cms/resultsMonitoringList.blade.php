		...
		<div class="navbar-fixed-top crumb" >
			...
			<div class="header-crumb">
				<ol class="breadcrumb" style=" border-radius:0; " >
					<li class="active"><a href="{{ url(session('userBUCode').'/cms/resultsmonitoring') }}" class="no-waiting">Results Monitoring <span class="badge" style="top:-9px; position:relative;"></span></a></li>
				</ol>
			</div>
			</div>
		</div>
...
$(document).ready(function(e)
{
	...
	var table = $('#QueueListTable').DataTable({
		...
		processing: true,
		serverSide: true,
		ajax: "{{ route('cmsResultsMonitoring.PatientList') }}",
		autoWidth		: false,
		deferRender		: true,

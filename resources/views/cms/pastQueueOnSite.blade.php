        ...
        <div class="col-menu-10">
            <div class="header-crumb">
                <ol class="breadcrumb" style=" border-radius:0; " >
                    <li class="active"><a href="{{ url(session('userBUCode').'/cms/pastqueueonsite') }}" class="waiting">Past Queue (IMD)<span class="badge" style="top:-9px; position:relative;"></span></a></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-menu">
            <div class="btn-group col-xs-12 col-sm-12 col-md-12" style="background-color:#8F8F8F; height:inherit;">
            	<div class="col-xs-12 col-sm-9 col-sm-offset-3 col-md-7 col-md-offset-5 col-lg-4 col-lg-offset-8">
                    ...
                    <a class="waiting btn btn-primary col-xs-6 col-sm-6 col-md-6 col-lg-6" style=" visibility:hidden; border-radius:0px; line-height:29px;" role="button"><span class="spinnerbtn"><i class="fa fa-spinner fa-spin hide"></i></span> Create</a>
...
$(document).ready(function(e)
{
	...
	$('.table-queue').append($html);
		...
		var table = $('#QueueListTable').DataTable({
			processing: true,
			serverSide: true,
			ajax: "{{ route('pastqueueonsite.getList') }}",
			autoWidth		: false,
			deferRender		: true,
			...
			{ "data": "QDate", "render": function(data,type,row,meta) { return '<div class="wrap-row">'+data+'</div>'; } },
			//{ "data": "QDate", "render": function(data,type,row,meta) { var dNotes = (data == null)?"":data;  return '<div class="wrap-row">'+dNotes+'</div>'; } },
		...
		$('#QueueListTable').on('click','.data-row',function(e){
			...
			hyperlink.href = 'pastqueueonsite/'+id+'/edit';

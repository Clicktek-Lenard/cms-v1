...
<div class="container-fluid">
	<div class="navbar-fixed-top crumb" >
		...
		<li class="active"><a href="{{ url(session('userBUCode').'/processing/evaluated') }}" class="no-waiting">Company Evaluation <span class="badge" style="top:-9px; position:relative;"></span></a></li>
                   <li class="active"><a  href="{{ url(session('userBUCode').'/processing/evaluated/company').'/'.$_GET['companyid'].'/edit' }}" class="no-waiting">{{ $compaName}}  <span class="badge" style="top:-9px; position:relative;"></span></a></li>
    ...
    <div class="navbar-fixed-bottom" >
		...
		<div class="col-xs-6">
			<button class="viewPrintEvalbtn btn btn-info col-xs-4 col-sm-4 col-md-4 col-lg-4"  style="border-radius:0px; line-height:29px;" type="button"> Print Preview </button>
		</div>
		<div class="col-xs-6">
			@if(strpos(session('userRole'), '"ldap_role":"[CMS-CSR-VIEW]"') === false)
				...
				@if( $datas->QueueStatus  === "Evaluated")
					<a class="tagCheckedlbtn btn btn-primary col-xs-4 col-sm-4 col-md-4 col-lg-4 "  style="border-radius:0px; line-height:29px;" role="button"><span class="spinnerbtn"><i class="fa fa-spinner fa-spin hide"></i></span> Tag as Checked</a>					
				@else
					<a class="btn btn-primary col-xs-4 col-sm-4 col-md-4 col-lg-4 disabled" disabled="disabled"  style="border-radius:0px; line-height:29px;" role="button"><span class="spinnerbtn"><i class="fa fa-spinner fa-spin hide"></i></span> Tag as Checked</a>					
				@endif
			@endif	
		</div>
            </div>
...
calculateBMI();
	...
	$('.tagCheckedlbtn').on('click',function(e)
	{
		if ("{{ $datas->QueueStatus }}" == "Evaluated")
		{
			parent.postData(
				"{{ '/processing/evaluated/company/patient?id='.$datas->Id }}",
				{  
				...
				{  
					...
					hyperlink.href = '/processing/evaluated/company/patient/'+$data+'/edit/?companyid='+{{ $_GET['companyid']}};

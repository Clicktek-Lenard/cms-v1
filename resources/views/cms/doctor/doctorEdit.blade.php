...
<div class="container-fluid">
						...
						<div class="col-lg-12 ">
							...
							<div id="section-4" class="form-section family " hidden> 
								...
								<div class="form-group-inline">
									...
									<input type="text" class="underline-input fnone form-control" required placeholder="Bronchial Asthma" {{$PEdata[0]->BronchialAsthma ?? ''}} name="BronchialAsthma">
									
									<label class="checkbox-inline">
										 Goiter
									</label>
									<input type="text" class="underline-input fnone form-control" required placeholder=" Goiter" {{$PEdata[0]->Goiter ?? ''}} name="Goiter">
									
									<label class="checkbox-inline">
										 Heart Disease
									</label>
									<input type="text" class="underline-input fnone form-control" required placeholder="Heart Disease" {{$PEdata[0]->FHeartDisease ?? ''}} name="HeartDiseaseF">
									
									<label class="checkbox-inline">
										 Kidney Disease
									</label>
									<input type="text" class="underline-input fnone form-control" required placeholder="Kidney Disease" {{$PEdata[0]->KedneyDisease ?? ''}} name="KidneyDiseaseF">
								</div>
								<div class="form-group-inline">
									<label class="checkbox-inline">
										 Diabetes Mellitus
									</label>
									<input type="text" class="underline-input fnone form-control" required placeholder="Diabetes Mellitus" {{$PEdata[0]->FDiabetesMellitus ?? ''}} name="DiabetesMellitusF">
									
									<label class="checkbox-inline">
										 PTB
									</label>
									<input type="text" class="underline-input fnone form-control" required placeholder="PTB" {{$PEdata[0]->PTB ?? ''}} name="PTB">
									
									<label class="checkbox-inline">
										Hypertension
									</label>
									<input type="text" class="underline-input fnone form-control" required placeholder="Hypertension" {{$PEdata[0]->FHypertension ?? ''}} name="HypertensionF">
									
									<label class="checkbox-inline">
										 Others
									</label>
									<input type="text" class="underline-input fnone form-control" required placeholder="Others" {{$PEdata[0]->FamilyOthers ?? ''}} name="FamilyOthers">
								</div>
							</div>
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="input-group">
											...
											<input type="text" class="form-control" name="ChiefComplaint" style="z-index: -0" value="{{$vitals->ChiefComplaint ?? ''}}" >
										</div>
									</div>
								</div>
							</div>
					...
					<!-- Left Column -->
							<div class="col-lg-6">
								<div class="row form-group">
									<div class="col-12">
										<label class="bold" style="padding-left: 3rem">Subjective<span style="color:red">*</span></label>
										<div class="textarea-container">
											<textarea name="subjective" id="subjective" rows="9" required placeholder="Subjective"> @if(empty($soap->Subjective)) @else {{$soap->Subjective}} @endif</textarea>
										</div>
									</div>
								</div>
								<div class="row form-group">
									<div class="col-12">
										<label class="bold" style="padding-left: 3rem">Objective<span style="color:red">*</span></label>
										<div class="textarea-container">
											<textarea name="objective" id="objective" rows="9" required placeholder="Objective">@if(empty($soap->Objective)) @else{{$soap->Objective}} @endif</textarea>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-6">
								<div class="row form-group">
									<div class="col-12">
										<label class="bold" style="padding-left: 3rem">Assessment<span style="color:red">*</span></label>
										<div class="textarea-container">
											<textarea name="assessment" id="assessment" rows="9" required placeholder="Assessment">@if(empty($soap->Assessment))  @else{{$soap->Assessment}} @endif</textarea>
										</div>
									</div>
								</div>  
								<div class="row form-group">
									<div class="col-12">
										<label class="bold" style="padding-left: 3rem">Plan <span style="color:red">*</span></label>
										<div class="textarea-container">
											<textarea name="plan" id="plan" rows="9" required placeholder="Plan">@if(empty($soap->Plan))  @else{{$soap->Plan}} @endif</textarea>
										</div>
									</div>
								</div>
							</div>
    ...
    <div class="navbar-fixed-bottom">
		...
		<div class="col-xs-6">
			...
			<a class="reccomendbtn btn btn-success col-xs-4 col-sm-4 col-md-4 col-lg-4 " style="  border-radius:0px; line-height:29px;" type="button"><span class="spinnerbtn"><i class="fa fa-spinner fa-spin hide"></i></span> Test Recommendation</a>
...
var table = $('#ResultListTable').DataTable({
   ...
   // if (event.which === 13) { // 13 is the Enter key
	...
	function updatePersonalSocial() {
            let allChecked = true; // Assume all are checked unless we find an unchecked pair
            ...
            requiredGroups.forEach(pair => {
                ...
                if (!isChecked) {
                    allChecked = false; // If one pair is missing, we mark as false
                }
            });
...
// Listen for changes on the checkbox
	...
	$('.savebtn').on('click',function(e){
		...
		parent.postData(
				"{{ '/doctor/queue/'.$datas->Id }}",
				{
					'IdDoctor':$('input[name=_idDoctor]').val(),
					'IdPatient':$('input[name=IdPatient]').val(),
					
					// ******** SOAP ************//
					'Subjective' 			: $('textarea[name=subjective]').val()
					,'Objective' 			: $('textarea[name=objective]').val()
					,'Assessment' 			: $('textarea[name=assessment]').val()
					,'Plan' 				: $('textarea[name=plan]').val()
					,'transactiontype'		: $('input[name=transactiontype]').val()
					,'_pricegroup'			: $('input[name=_pricegroup]').val()
					,'_token'				: $('input[name=_token]').val()
					,'_method'				:'PUT'
					// ******** PE ************//
					...
					//----------------------Vital Sign-------------------------//
					,'ChiefComplaint' : $('input[name=ChiefComplaint]').val()

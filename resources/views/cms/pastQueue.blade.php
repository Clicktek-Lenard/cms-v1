        ...
        <div class="col-menu-10">
            <div class="header-crumb">
                <ol class="breadcrumb" style=" border-radius:0; " >
                    <li class="active"><a href="{{ url(session('userBUCode').'/cms/pastqueue') }}" class="waiting">Past Queue <span class="badge" style="top:-9px; position:relative;"></span></a></li>
                </ol>
            </div>
        </div>
    </div>
...
$(document).ready(function(e)
{
	...
	$('.table-queue').append($html);
		...
		$('#QueueListTable').on('click','.data-row',function(e){
			...
			hyperlink.href = 'pastqueue/'+id+'/edit';

						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="row form-group row-md-flex-center">
								...
								<div class="col-sm-4 col-md-4">
									<input type="text" class="form-control" name="lastname" placeholder="Last Name" required="required" value="{{ $datas[0]->LastName }}">
								</div>
								<div class="col-sm-2 col-md-2 pad-0-md text-right-md  ">
									<label class="bold ">First Name<font style="color:red;">*</font></label>
								</div>
								<div class="col-sm-4 col-md-4">
									<input type="text" class="form-control" name="firstname" placeholder="First Name" required="required" value="{{ $datas[0]->FirstName }}">
								</div>
								<div class="col-sm-2 col-md-2 pad-0-md text-right-md  ">
									<label class="bold ">Middle Name<font style="color:red;"></font></label>
								</div>
								<div class="col-sm-4 col-md-4">
									<input type="text" class="form-control" name="middlename" placeholder="Middle Name" value="{{ $datas[0]->MiddleName }}" >
								</div>
							</div>
							<div class="row form-group row-md-flex-center">
								<div class="col-sm-2 col-md-2 pad-0-md text-right-md  ">
								...
								<div class="col-sm-12 col-md-12 text-left-md">
									<input type="text" class="form-control" name="fullname" placeholder="Display Name" required="required" value="{{ $datas[0]->FullName }}">
								</div>
							...
							<div class="row form-group row-md-flex-center">
								...
								<div class="col-sm-4 col-md-4">
									<input type="text" class="form-control" name="prcno" placeholder="PRC No." required="required"  value="{{ $datas[0]->PRCNo }}">
								</div>
								<div class="col-sm-2 col-md-2 pad-0-md text-right-md  ">
									<label class="bold ">Specialization<font style="color:red;"></font></label>
								</div>
								<div class="col-sm-4 col-md-4">
									<input type="text" class="form-control" name="specialization" placeholder="Specialization" value="{{ $datas[0]->Description }}" >
								</div>
								<div class="col-sm-2 col-md-2 pad-0-md text-right-md  ">
									<label class="bold ">Eros Code<font style="color:red;"></font></label>
								</div>
								<div class="col-sm-4 col-md-4">
									<input type="text" class="form-control" name="eroscode" readonly="readonly" placeholder="System Generated" value="{{ $datas[0]->ErosCode }}" >
								</div>
							</div>
						</div>
					</div>
		...
		<div class="col-menu">
			<div class="btn-group col-xs-12 col-sm-12 col-md-12" style="background-color:#8F8F8F; height:inherit;">
				<div class="col-xs-12 col-sm-9 col-sm-offset-3 col-md-7 col-md-offset-5 col-lg-4 col-lg-offset-8">
					<button class="updatebtn btn btn-primary col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xs-offset-6 col-sm-offset-6 col-md-offset-6 col-lg-offset-6" style="border-radius:0px; line-height:29px;" type="button"> Update </button>
				</div>
			</div>
		</div>
	</div>

		...
		<div class="navbar-fixed-top crumb" >
			...
			<div class="header-crumb">
				<ol class="breadcrumb" style=" border-radius:0; " >
					<li class="active"><a href="{{ url(session('userBUCode').'/hclab') }}" class="waiting">SERVER HCLAB  - Online PDF <span class="badge" style="top:-9px; position:relative;"></span></a></li>
				</ol>
			</div>
			</div>
		</div>
...
$(document).ready(function(e)
{
	...
	//	"processing": true,
	//	"serverSide": true,
	//	"ajax": "{{ route('hclabserver.PDFlist') }}",
	//	columns: [

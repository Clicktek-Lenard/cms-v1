		...
		<div class="col-menu-10">
			<div class="header-crumb">
				<ol class="breadcrumb" style=" border-radius:0; " >
					...
					<li class="active"><a href="#">Package Add <span class="badge" style="top:-9px; position:relative;"></span></a></li>
				</ol>
			</div>
		</div>
	</div>
				...
				<input type="hidden" name="_token" value="{{ csrf_token() }}">
					<div class="row form-group row-md-flex-center">
							...
							<div class="col-sm-6 col-md-6">
								<input type="text" class="form-control" name="packageName" placeholder="Package Name" required="required" value="">
							</div>
							<div class="col-sm-2 col-md-2">
								<input type="text" class="form-control" name="packageAmount" placeholder="Package Amount" required="required" value="">
							</div>
							<div class="col-sm-2 col-md-2">
								<select name="modalClinics" class="form-control rowview" placeholder="Clinic Name" required="required" >
									@foreach ($clinics as $clinic)
										<option value="{{ $clinic->Code }}">{{ $clinic->Description }}</option>
									@endforeach
								</select>
							</div>
							<div class="col-sm-2 col-md-2">
								<input type="text" class="form-control" name="packageCode" placeholder="System Generated Package Code" readonly="readonly" value="">
							</div>

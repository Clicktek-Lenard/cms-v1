...
<div class="container-fluid">
	<div class="navbar-fixed-top crumb" >
		...
		<ol class="breadcrumb" style=" border-radius:0; " >
			...
			<li class="active"><a href="#">Client Information Sheet Uploading <span class="badge" style="top:-9px; position:relative;"></span></a></li>
		</ol>
            </div>
        </div>
    </div>
	...
	<form id="formQueueCreate" class="form-horizontal" role="form" method="POST" action="{{ url(session('userBUCode').'/erosui/company/itemspackages/lab2lab') }}" enctype="multipart/form-data">
		...
		<div class="panel panel-primary">
			<div class="panel-heading" style="line-height:12px;">Allowed only Excel and PDF file</div>
        ...
        <div class="col-menu">
            <div class="btn-group col-xs-12 col-sm-12 col-md-12" style="background-color:#8F8F8F; height:inherit;">
            	<div class="col-xs-12 col-sm-9 col-sm-offset-3 col-md-7 col-md-offset-5 col-lg-4 col-lg-offset-8">
                    ...
                    <button class="download-template btn btn-warning col-xs-6 col-sm-6 col-md-6 col-lg-6" style="visibility:hidden;  border-radius:0px; line-height:29px;" type="button"><span class="spinnerbtn"><i class="fa fa-spinner fa-spin hide"></i></span> Download Template</button>
